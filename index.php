...
<!-- Start of owners testimonials section
	...
	<section id="it-up-owners-testimonials" class="it-up-announcements-section">
		<div class="container">
			<div class="owners-testimonial-wrap">
				<div class="it-up-section-title headline-1" style="margin-bottom: 12px; text-align: center;">
					<span>_Owners Testimonials_</span>
					<h2>What Owners Say</h2>
				</div>
				<div class="owners-testimonial-carousel owl-carousel owl-theme">
					<div class="owners-testimonial-item">
						<div class="owners-testimonial-card">
							<p>"Non-members do not know the purpose of the association. They think the association is established only to collect money for cleaning purposes, but they must understand the association is safeguarding our property. I am honestly satisfied with the recent initiatives taken by Mr. Alex and team. I was reluctant to pay previously, but Mr. Alex and team proved that every rupee is worth it for owners. Big thanks to the association."</p>
							<h4 class="owners-testimonial-author">- Somasekar, Ph 2, Site 13</h4>
						</div>
					</div>
					<div class="owners-testimonial-item">
						<div class="owners-testimonial-card">
							<p>"Association has taken huge responsibility to create very high value for your property. They are doing massive work at your site. You may be thinking why to pay maintenance, but please think: even if you pay continuously for five years, you may lose hardly Rs. 25,000. In return, you will be benefited in lakhs. You are paying only a small share and watching what is happening, but the committee is not sleeping. They have taken the burden to clean your premises at a very nominal cost."</p>
							<p>"Please try to understand the situation and support the association by paying your old dues as well as Rs. 5,026 for the current year. I hope all owners will support at the earliest so we can take the process to the next level."</p>
							<h4 class="owners-testimonial-author">- Arun Kumar (Owner)</h4>
						</div>
					</div>
					<div class="owners-testimonial-item">
						<div class="owners-testimonial-card">
							<p>"I heartily thank all the members of the coordination committee for their enthu and zeal with which they hv come forward to take up this social work on others behalf, but for ur initiative we really really wd not hv seen these golden moments which are very encouraging n giving hopes about the future of this, HITHERTO passive layout."</p>
							<h4 class="owners-testimonial-author">- Vijaya, Phase 1</h4>
						</div>
					</div>
					<div class="owners-testimonial-item">
						<div class="owners-testimonial-card">
							<p>"I want to thank our Manager and the committee for doing such a wonderful job which has transformed our layout like magic into a beautiful one. Our best wishes and blessings to all."</p>
							<h4 class="owners-testimonial-author">- Chandrasekar (received as audio message)</h4>
						</div>
					</div>
				</div>
			</div>
