				...
				<div class="it-up-banner-text headline-1 pera-content">
					...
					<div class="it-up-banner-btn d-flex">
						...
						<div class="it-up-banner-cta-btn text-center">
							<a class="nav-link" href="association.php#it-up-contact">Get in Touch <i class="fas fa-arrow-right"></i></a>
						</div>
					</div>
				</div>
...
<!-- Start of social media CTA section
	============================================= -->
	<section id="it-up-social-cta" style="background: #f8f9fa; padding: 28px 0; border-top: 1px solid #eee; border-bottom: 1px solid #eee;">
		<div class="container text-center">
			<span style="font-size: 20px; font-weight: 600; color: #444; margin-right: 20px; vertical-align: middle;">Follow us on Social Media</span>
			<a href="<?php echo SOCIAL_FACEBOOK; ?>" target="_blank" rel="noopener noreferrer" title="Facebook" style="color: #1877f2; font-size: 30px; margin: 0 12px; vertical-align: middle;"><i class="fab fa-facebook-f"></i></a>
			<a href="<?php echo SOCIAL_TWITTER; ?>" target="_blank" rel="noopener noreferrer" title="X (Twitter)" style="color: #111; font-size: 30px; margin: 0 12px; vertical-align: middle;"><i class="fab fa-twitter"></i></a>
			<a href="<?php echo SOCIAL_INSTAGRAM; ?>" target="_blank" rel="noopener noreferrer" title="Instagram" style="color: #e1306c; font-size: 30px; margin: 0 12px; vertical-align: middle;"><i class="fab fa-instagram"></i></a>
			<a href="<?php echo SOCIAL_YOUTUBE; ?>" target="_blank" rel="noopener noreferrer" title="YouTube" style="color: #ff0000; font-size: 30px; margin: 0 12px; vertical-align: middle;"><i class="fab fa-youtube"></i></a>
			<a href="<?php echo SOCIAL_THREADS; ?>" target="_blank" rel="noopener noreferrer" title="Threads" style="color: #111; font-size: 30px; margin: 0 12px; vertical-align: middle;"><i class="fab fa-threads"></i></a>
		</div>
	</section>
		...
		<div class="container">
			<div class="owners-testimonial-wrap">
				...
				<div class="owners-testimonial-carousel owl-carousel owl-theme">
					...
					<div class="owners-testimonial-item">
						<div class="owners-testimonial-card">
							<p>"Agree and Great work leading from front @Alexander Watkins Myciti. I watched many videos / photos posted in last month or so and remembered what a jungle it used to be, in the year around 2019. Since then it has definitely come a long way. We certainly need everyone to pay to make it a marketable layout so that people can come and invest."</p>
							<h4 class="owners-testimonial-author">- Owner</h4>
						</div>
					</div>
				</div>
			</div>
					...
					<div class="col-lg-3 col-md-6">
						<div class="it-up-footer-widget headline-1 pera-content">
							<div class="it-up-footer-logo-widget it-up-headline pera-content">
								...
								<a class="footer-logo-btn text-center text-capitalize" "nav-link" href="association.php#it-up-contact">Get In Touch <i class="fas fa-arrow-right"></i> </a>
							</div>
						</div>
					</div>
					<div class="col-lg-3 col-md-6">
